...
![RePC: выбор данных и сохранение паспорта](assets/workflow-save.png)

![RePC: открытый паспорт и выбор данных для восстановления](assets/workflow-restore.png)

Снимки тестовой сборки, счётчики содержат тестовые данные.
